...
//
vc_map( array(
        "name"      => __( "Banner Slideshow", "mk_framework" ),
        "base"      => "mk_mobile_slideshow",
        'icon' => 'icon-mk-image-slideshow vc_mk_element-icon',
        "category" => __('Slideshows', 'mk_framework'),
        'description' => __( 'Banner轮播图配置', 'mk_framework' ),
        "params"    => array(
            array(
                "type" => "range",
                "heading" => __( "轮播动画时间", "mk_framework" ),
                "param_name" => "animation_speed",
                "value" => "700",
                "min" => "100",
                "max" => "3000",
