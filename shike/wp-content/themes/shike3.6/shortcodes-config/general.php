...
vc_map(array(
    ...
    "params" => array(
        array(
            "type" => "toggle",
            "heading" => __("是否全宽", "mk_framework"),
            "param_name" => "full_width",
            "value" => "false",
            "description" => __("容器是否全宽", "mk_framework"),
        ),
        array(
            "type" => "textfield",
            "heading" => __("ID", "mk_framework"),
            "param_name" => "id",
            "value" => "",
...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "toggle",
            "heading" => __("点击查看", "mk_framework"),
            "param_name" => "hover",
            "value" => "false",
            "description" => __("移动端中点击查看图片", "mk_framework"),
        ),
         array(
            "type" => "textfield",
...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "param_name" => "title",
            "value" => "",
            "description" => __("标题", "mk_framework")
        ),

        array(
            "type" => "textfield",
            "heading" => __("Sub Title", "mk_framework"),
            "param_name" => "desc",
            "value" => "",
            "description" => __("副标题", "mk_framework")
        ),
        ...
        array(
            ...
            "param_name" => "link",
            "value" => "",
            "description" => __("链接", "mk_framework")
        ),

        array(
            "type" => "upload",
            "heading" => __("配图", "mk_framework"),
            "param_name" => "imgurl",
            "value" => "",
            "description" => __("大小500*500px", "mk_framework")
        ),
