    ...
    if ( ! class_exists( 'Redux_Framework_sample_config' ) ) {
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => __('上传Favicon', 'mk_framework'),
				'mode' => false,
				'desc' => __('favicon 尺寸 32X32 png file.', 'mk_framework'),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => __('上传Logo', 'mk_framework'),
				'mode' => false,
				'desc' => __('高 58px png file', 'mk_framework'),
				'subtitle' => __('', 'mk_framework'),
				'default' => false,
			),
			...
			array(
				...
				'type' => 'media',
				'url' => true,
				'title' => __('上传高清双倍Logo', 'mk_framework'),
				'mode' => false,
				'desc' => __('logo的双倍size', 'mk_framework'),
				'subtitle' => __('高清logo', 'mk_framework'),
				'default' => false,
			),
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'media',
                            'url' => true,
                            'title' => __('页脚logo', 'mk_framework'),
                            'mode' => false,
                            'desc' => __('', 'mk_framework'),
                            'subtitle' => __('图片大小：135*73px', 'mk_framework'),
                            'default' => false,
                        ),
                        array(
                            'id' => 'footer-copyright',
...
//                );
            ...
            public function setArguments() {
                ...
                $this->args = array(
                    ...
                    'menu_title'           => __( '网站配置', 'mk_framework' ),
                    'page_title'           => __( '网站配置', 'mk_framework' ),
