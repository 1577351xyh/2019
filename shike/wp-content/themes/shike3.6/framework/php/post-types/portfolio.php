...
function register_portfolio_post_type(){
	...
	register_post_type('portfolio', array(
		'labels' => array(
			'name' => __('案例', 'mk_framework' ),
			'singular_name' => __('Portfolio', 'mk_framework' ),
			'add_new' => __('新增案例', 'mk_framework' ),
			'add_new_item' => __('新增案例', 'mk_framework' ),
			'edit_item' => __('编辑案例', 'mk_framework' ),
			'new_item' => __('新案例', 'mk_framework' ),
			'view_item' => __('查看案例', 'mk_framework' ),
			'search_items' => __('搜索案例', 'mk_framework' ),
			'not_found' =>  __('未找到', 'mk_framework' ),
			'not_found_in_trash' => __('垃圾箱中未找到', 'mk_framework' ),
			'parent_item_colon' => '',
		),
	...
	register_taxonomy('portfolio_category','portfolio',array(
		'hierarchical' => true,
		'labels' => array(
			'name' => __( '案例分类', 'mk_framework' ),
			'singular_name' => __( '案例分类', 'mk_framework' ),
			'search_items' =>  __( '搜索案例分类', 'mk_framework' ),
			'popular_items' => __( '常用案例分类', 'mk_framework' ),
			'all_items' => __( '所有案例分类', 'mk_framework' ),
			'parent_item' => null,
			'parent_item_colon' => null,
			'edit_item' => __( '编辑案例分类', 'mk_framework' ),
			'update_item' => __( '更新案例分类', 'mk_framework' ),
			'add_new_item' => __( '新增案例分类', 'mk_framework' ),
			'new_item_name' => __( '新案例分类名称', 'mk_framework' ),
