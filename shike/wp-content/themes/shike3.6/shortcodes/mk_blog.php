...
/////////
if( (trim($el_class)=='answer')){ //指向产品问答
    $query = array(
        'posts_per_page' => (int) $count,
        'post_type' => 'answer',
    );
...
$output .= '<div class="loop-main-wrapper"><section id="mk-blog-loop-' . $id . '" class="mk-blog-container '.$el_class.'">' . "\n";
