...
//				$slide_item .= '<a href="'.$image_src_array[ 0 ].'" title="'.$image_title.'" rel="gallery-loop" class="mk-lightbox gallery-thumb-lightbox"><i class="mk-theme-icon-plus"></i></a>';
				...
				$thumb_item .= '<img style="width: 210px;" alt="'.$image_title.'" src="' . mk_thumbnail_image_gen($image_src, $width, $height) .'" />';
				$thumb_item .= '</a>';
			...
			$output .= '</div></div>';
			$output .= '<div class="gallery-thumbs-small"><div class="gallery-thumbs-container">' .$thumb_item. '</div><span class="left_arrow"></span><span class="right_arrow"></span></div>';
