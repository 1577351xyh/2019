<div id="datas-wrap">
    ...
    <table class="wp-list-table widefat fixed datas" cellspacing="0">
        ...
        <tr>
            ...
            <th scope="col" id="category" class="manage-column" style="">分类</th>
            <th scope="col" id="describe" class="manage-column" style="">描述</th>
            <th scope="col" id="att" class="manage-column" style="">链接属性</th>
            <th scope="col" id="priority" class="manage-column" style=""><span>权重</span><span class="sorting-indicator"></span></th>
        </tr>
        </thead>
