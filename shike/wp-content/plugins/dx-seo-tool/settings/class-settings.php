...
class DX_Seo_Settings {
	...
	function plugin_des_link( $links, $file ) {
		if( DXSEO_FILE == $file ) {
//			$links['donate'] = '<a href="https://me.alipay.com/daxiawp" target="_blank"></a>';
		}
		return $links;
	}
	...
	function add_admin_menu() {
		$this->hook_suffix = add_menu_page( 'DX-Seo', 'dx-Seo', 'manage_options', $this->slug, array( $this, 'menu_page' ), false );
		// Theme store
		if( ! class_exists( 'Daxiaw
		p_Plugin_Theme' ) )
