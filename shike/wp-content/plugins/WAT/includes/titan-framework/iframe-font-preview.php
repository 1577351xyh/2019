...
<html>
	<head>
		...
		if ( $_GET['font-type'] == 'google' ) {
			...
			printf( "<link rel='stylesheet' href='http://fonts.useso.com/css?family=%s:400,%s&subset=latin,cyrillic-ext,greek-ext,greek,latin-ext,vietnamese,cyrillic' type='text/css' media='all' />",
