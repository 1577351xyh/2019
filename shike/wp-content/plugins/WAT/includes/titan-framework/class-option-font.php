...
class TitanFrameworkOptionFont extends TitanFrameworkOption {
	...
	public static $webSafeFonts = array(
		...
		'PingHei, "PingFang SC", "Helvetica Neue", Helvetica, STHeitiSC-Light, "Microsoft YaHei", 黑体, Arial, sans-serif' => '中文字体',
...
//			$fontUrl = sprintf( "//fonts.useso.com/css?family=%s:%s&subset=%s",
